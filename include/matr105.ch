	...
	#define STR0014 "Item"
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Número  Item  Código             Descrição                        UM Emissão            Quantidade              Saldo        Qtd.entregue   Requisição         Centro De Custo    Solicitante", "Numero  Item  Codigo             Descricao                        Emissao            Quantidade              Saldo        Qtd.Entregue   Requisicao         Centro de Custo    Solicitante" )
		#define STR0009 "Saldo"
