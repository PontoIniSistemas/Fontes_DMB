...
oReport:= TReport():New("AFATR01",cTitle,"AFATR01", {|oReport| ReportPrint(oReport)},"Orçamentos por Vendedor..")
oReport:SetPortrait()
//oReport:HideHeader()
...
**
	...
	PutSx1("AFATR01","01","Data Inicial     ?","Data Inicial Dados ?","Data Inicial Dados  ?","mv_ch01","D",08,00,01,"G","",""   ,"","","mv_par01","","","","","","","","","","","","","","","","",{ OemToAnsi("Define a Data Inicial para busca")}, { OemToAnsi("dos dados")}, {} )
	PutSx1("AFATR01","02","Data Final       ?","Data Final Dados   ?","Data Final Dados    ?","mv_ch02","D",08,00,01,"G","",""   ,"","","mv_par02","","","","","","","","","","","","","","","","",{ OemToAnsi("Define a Data Final para busca")}  , { OemToAnsi("dos dados")}, {} )
	PutSx1("AFATR01","03","Vendedor Inicial ?","Vendedor Inicial   ?","Vendedor Inicial    ?","mv_ch03","C",06,00,01,"G","","SA3","","","mv_par03","","","","","","","","","","","","","","","","",{ OemToAnsi("Define os Vendedores"),OemToAnsi("que devem ser filtrados no"),OemToAnsi("relatorio!")}, {}, {} )
	PutSx1("AFATR01","04","Vendedor Final   ?","Vendedor Final     ?","Vendedor Final      ?","mv_ch04","C",06,00,01,"G","","SA3","","","mv_par04","","","","","","","","","","","","","","","","",{ OemToAnsi("Define os Vendedores"),OemToAnsi("que devem ser filtrados no"),OemToAnsi("relatorio!")}, {}, {} )
	PutSx1("AFATR01","05","Considerar Status?","Considerar Status  ?","Considerar Status   ?","mv_ch05","N",01,00,01,"C","","","","","mv_par05","Nao","Nao","Nao","", "Sim","Sim","Sim","","","","","","","","","",{"Considera parametros abaixo", " para impressao",""},{"",""} ,	{"",""})
	PutSx1("AFATR01","06","Qual Status      ?","Qual Status        ?","Qual Status         ?","mv_ch06","N",01,00,01,"C","","","","","mv_par06","Aberto","Aberto","Aberto","", "Baixado","Baixado","Baixado","Cancelado","Cancelado","Cancelado","Nao Orcado","Nao Orcado","Nao Orcado","Bloqueado","Bloqueado","Bloqueado",{"Define os Status dos Orcamentos", "que deverao ser impressos",""},{"",""} ,	{"",""})
